...
export function DashboardPage() {
  ...
  const kpiRow2 = [
    ...
    { label: "SOCIETIES", value: stats?.societies_count ?? "—", icon: Building2, color: "bg-blue-50 text-blue-700 border-blue-100" },
    { label: "BLOCKS", value: stats?.blocks_count ?? "—", icon: Building, color: "bg-indigo-50 text-indigo-700 border-indigo-100" },
  ];
